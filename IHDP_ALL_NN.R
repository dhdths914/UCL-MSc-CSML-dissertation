...
###### Normal ANN ######
# Load the data
all_IHDP <- read.csv('/Users/dhdths914/Documents/UCL-CSML/Project/all_code/new_data/IHDP data/train_dat_3.csv',header = F)
X_test <- read.csv('/Users/dhdths914/Documents/UCL-CSML/Project/all_code/new_data/IHDP data/X_test_3.csv',header=F)
Y_test <- read.csv('/Users/dhdths914/Documents/UCL-CSML/Project/all_code/new_data/IHDP data/Y_test_3.csv',header=F)
...
#write.csv(f_hat_in_test,file="/Users/dhdths914/Documents/UCL-CSML/Project/all_code/new_data/NN IHDP/nn_IHDP_allresult.csv")
